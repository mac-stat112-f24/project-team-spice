...
album_topics <- topics_wide |> 
  group_by(Album) |>
  summarize(average_score_1 = mean(`1`, na.rm = TRUE), 
         average_score_2 = mean(`2`, na.rm = TRUE), 
         average_score_3 = mean(`3`, na.rm = TRUE)) |> 
  pivot_longer(cols = c(average_score_1, average_score_2, average_score_3),
               names_to = "topics",
               values_to = "average"
  )
